...
const lowCaseAnimalNames = zooAnimals.map(function(currentVal) {
    return currentVal.animal_name.toLowerCase();
});
...
const lowPopulationAnimals = zooAnimals.filter(function(currentVal) {
    return currentVal.population < 5;
})
...
let populationTotal = zooAnimals.reduce(function(accumulator, currentVal) {
